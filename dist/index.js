...
const mongoose_1 = require("./src/models/routes/mongoose");
...
app.get("/holidays", cors(corsOptions), (req, res) => {
    res.status(200);
    res.json(holidayData);
});
app.post("/products", cors(corsOptions), mongoose_1.createProduct);
app.get("/products", cors(corsOptions), mongoose_1.getProducts);
app.listen(port, () => {
